...
class User {
    constructor(firstName, lastName, password, email, phoneNumber, studyProgramme) {
...
class Student extends User {
    constructor(userName, password, email, phoneNumber, firstName, lastName, studyProgramme, semester) {
